      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              <Diamond className="w-6 h-6 text-violet-500" />
              <span className="font-display text-xl text-white font-bold">NICHE</span>
            </div>
            <p className="text-white/40 text-sm leading-relaxed">
              Where professionals shape what gets built for their world
            </p>
          </motion.div>
        ...
        >
          <p className="text-sm text-white/30">
            © 2026 NICHE. Built by a solo founder who needed this.
          </p>
        </motion.div>
      </div>
    </footer>
